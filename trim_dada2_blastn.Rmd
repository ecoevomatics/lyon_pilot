...
##EXTRACT fasta of ASV sequences from sequence table with chimeras removed
```{r}
...
```{bash}
##Make header table
echo -e "Query_ID\tQuery_Length\tSubject_ID\t%_Identity\tAlignment_Length\tQuery_Start\tQuery_End\tSubject_Start\tSubject_End\tE-value\tBit_Score\tSubject_Taxonomy_ID" > lyon_pilot_all_blast_merged_labelled.out
