...
#how many data points should be displayed for class and order?
...
#try removing rare taxa to get more realistic stress value
...
Ordination biplots to display samples and OTUs side by side
```{r}
